...
test.describe('User Profile Management', () => {
  ...
  test('should edit profile name and save successfully', async ({ page }) => {
    await allure.suite('Profile');
    await allure.severity('blocker');
    await allure.description('Verify that user can edit profile name and save successfully');
  ...
  test('should edit profile gender and save successfully', async ({ page }) => {
    await allure.suite('Profile');
    await allure.severity('normal');
    await allure.description('Verify that user can change gender and save profile successfully');
  ...
  test('should logout successfully', async ({ page }) => {
    ...
    // Wait for "Logged out successfully" toast or page to load
